...
<div class="container">
    ...
    <img src="<c:url value="/img/anifox.png"/>" class="img-fluid">
    <section class="py-5">
    ...
    <div class="py-5 bg-image-full" style="background-image: url('<c:url value="/img/anime-font.jpg"/>')">
    ...
    <br>
    <br>
        <img src="<c:url value="/img/list.png"/>" class="img-fluid"  alt="List" >
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-lg-6">
    ...
    <img src="<c:url value="/img/calendar.png"/>" calt="Calendar"> <section class="py-5">
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <h4 >Будь в курсе!</h4>
